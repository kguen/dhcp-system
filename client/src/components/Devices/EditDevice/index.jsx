...
export const EditDevice = ({ doSubmit, initialData, orgList, userList }) => {
          ...
          <Modal.Body>
            <Form.Row>
              ...
              <Form.Group className="col-7" controlId="formUserId">
                ...
                <Form.Text className="text-muted">
                  Nếu thay đổi thì một địa chỉ IP từ subnet đơn vị của người
                  dùng mới sẽ được cấp phát cho thiết bị.
                </Form.Text>
              </Form.Group>
            </Form.Row>
            <Form.Row>
